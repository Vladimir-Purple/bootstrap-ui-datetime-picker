        ...
        function ($compile, $parse, $document, $timeout, $position, dateFilter, dateParser, uiDatetimePickerConfig) {
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    // if custom button closes input, wrap it in a function.
                    if (scope.customButtonClose === 'true') {
                        var customFunc = scope.customButtonAction;
                        scope.customButtonAction = null;
                        scope.customButtonAction = function() {
                            customFunc();
                            scope.close();
                        }
                    }
                    ...
                    scope.dateSelection = function (dt) {
                        ...
                        if (angular.isDefined(dt)) {
                            // if minutes disabled, their value will be zero.
                            if (scope.disableMinutes === 'true') {
                                dt.setMinutes(0);
